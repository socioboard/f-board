...
public class PagesSearch_Adapter  extends BaseAdapter
{
	...
	public PagesSearch_Adapter(Context context, ArrayList<PagesSearch_Model> pageslist) 
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		if (convertView == null)
		{
			...
			convertView = mInflater.inflate(R.layout.pages_search_fragment_rowitem, parent, false);
		}
