...
import com.socioboard.f_board_pro.fragments.DisplayGroupFeedFragment.CallToFbLike;
		  ...
		  protected String doInBackground(String... params)
			  {
			   ...
			   String URL = "https://graph.facebook.com/"+ MainSingleTon.selectedHomeFeed.getFeedId()+ "/likes";
			 String access="https://graph.facebook.com";
			   
			  		   
			   String postURL = access+"/"+MainSingleTon.selectedHomeFeed.getFeedId()+"/likes&access_token="+MainSingleTon.accesstoken;
			    ...
			    try 
			    {
			        ...
			        System.out.println("responce body "+body);    
