...
/**
 * Created by GLB-122 on 8/9/2017.
 */

public class SharegonGroupAdapter extends BaseAdapter
{
    ...
    public SharegonGroupAdapter(Context context, ArrayList<SchPostModel>schTweetModels){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.shareagon_group_item, parent,
                    false);
        }

        final SchPostModel schfeedModel = (SchPostModel) getItem(position);
        ...
        userName.setText("Account Name: "+ schfeedModel.getUserID());

        groupName.setText("Group Name :"+schfeedModel.getGroup_name());
        ...
        likesper_minute.setText(schfeedModel.getInterval()+" Post per minute ");
    ...
    public void deleteScheduleDialog(final SchPostModel  schPostModel, final int positttn)
    {
        ...
        yesBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                database.deleteThisShareGroup(schPostModel.getFeedId());
