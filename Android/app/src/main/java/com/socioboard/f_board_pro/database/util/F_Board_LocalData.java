...
public class F_Board_LocalData extends SQLiteOpenHelper {
	...
	public ArrayList<HashMap<String,String>> getAllUsersData() {
		...
		MainSingleTon.useraccesstokenlist.clear();
		if (cursor.moveToFirst()) {
			...
			do {
				...
				MainSingleTon.useraccesstokenlist.add(cursor.getString(3));
                hashMap.put("userId",cursor.getString(0));
                hashMap.put("userImage",cursor.getString(1));
                hashMap.put("userName",cursor.getString(2));
                hashMap.put("userAccessToken",cursor.getString(3));
	...
	public String returnAccessTokenByUserId(String userId)
	{
		String accessToken="";
		String query = "SELECT * FROM " + table_name + " WHERE " + KEY_UserID
				+ " = '" + userId + "'";
