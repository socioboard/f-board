...
/**
 * Created by GLB-122 on 7/25/2017.
 */

public class SharegonPageAdapter extends BaseAdapter
{
    ...
    public SharegonPageAdapter(Context context, ArrayList<SchPostModel> schTweetModels) {
...
//                        Context.MODE_PRIVATE);
                ...
                database.deleteThisSharePages(schPostModel.getFeedId());
