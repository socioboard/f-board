...
public class Viewpageradapter extends PagerAdapter {
	...
	public Object instantiateItem(ViewGroup container, int position) {
		...
		View itemView = mLayoutInflater.inflate(R.layout.intro_viewpager_item, container,false);
		

		ImageView intro_imageView = (ImageView) itemView.findViewById(R.id.introImage);
