...
import com.socioboard.f_board_pro.adapter.SharegonGroupAdapter;
...
public class DetailsAboutPendingGroupShareagon extends Activity
{
    ...
    SharegonGroupAdapter shareagonAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shareagonAdapter = new SharegonGroupAdapter(DetailsAboutPendingGroupShareagon.this, schFeedArrlist);
        ...
        headerRlt.setOnClickListener(new View.OnClickListener() {
