...
@interface PAPBaseTextCellFboard () {
...
@implementation PAPBaseTextCellFboard
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        horizontalTextSpace =  [PAPBaseTextCellFboard horizontalTextSpaceForInsetWidth:cellInsetWidth];
...
+ (CGFloat)heightForCellWithName:(NSString *)name contentString:(NSString *)content {
    return [PAPBaseTextCellFboard heightForCellWithName:name contentString:content cellInsetWidth:0];
}
...
+ (CGFloat)heightForCellWithName:(NSString *)name contentString:(NSString *)content cellInsetWidth:(CGFloat)cellInset {
    ...
    NSString *paddedString = [PAPBaseTextCellFboard padString:content withFont:[UIFont systemFontOfSize:13] toWidth:nameSize.width];
    CGFloat horizontalTextSpace = [PAPBaseTextCellFboard horizontalTextSpaceForInsetWidth:cellInset];
...
- (void)setContentText:(NSString *)contentString {
    ...
    if (/* DISABLES CODE */ (1)) {
        CGSize nameSize = [self.nameButton.titleLabel.text boundingRectWithSize:CGSizeMake(nameMaxWidth, CGFLOAT_MAX)
                                                     ...
                                                     attributes:@{NSFontAttributeName:[UIFont boldSystemFontOfSize:13.0f]}
                                                        context:nil].size;
        NSString *paddedString = [PAPBaseTextCellFboard padString:contentString withFont:[UIFont systemFontOfSize:13] toWidth:nameSize.width];
...
- (void)setCellInsetWidth:(CGFloat)insetWidth {
    ...
    horizontalTextSpace = [PAPBaseTextCellFboard horizontalTextSpaceForInsetWidth:insetWidth];
    [self setNeedsDisplay];
}
