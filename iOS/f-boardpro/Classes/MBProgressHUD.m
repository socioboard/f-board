...
//	CGSize maxSize = CGSizeMake(maxWidth, remainingHeight);
    UIFont *fonts = [UIFont boldSystemFontOfSize: 20];
    NSDictionary *attributesa = @{NSFontAttributeName: fonts};
    CGSize detailsLabelSize=[detailsLabel.text sizeWithAttributes:attributesa];
