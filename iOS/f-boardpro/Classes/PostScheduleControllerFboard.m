...
@interface PostScheduleControllerFboard ()

@end

@implementation PostScheduleControllerFboard
...
- (void)setupLocalNotifications:(double )seconds {
    ...
    NSIndexPath *path=[SingletonClass sharedState].selectedUserIndex;
    FBSDKAccessToken *token = [SUCacheFboard itemForSlot:path.section+path.row].token;
    [FBSDKAccessToken setCurrentAccessToken:token];
