...
#import "PAPPhotoHeaderViewFboard.h"
#import "TimeIntervalFormatterFboard.h"
#import <FBSDKCoreKit/FBSDKCoreKit.h>
//#import "PAPUtility.h"
#import "UIImageView+WebCache.h"
#import "CommentsViewControllerFboard.h"
@class FBSDKProfilePictureView;
@interface PAPPhotoHeaderViewFboard()
{
    CommentsViewControllerFboard  * pdVC;
}
...
@implementation PAPPhotoHeaderViewFboard
...
- (id)initWithFrame:(CGRect)frame buttons:(PAPPhotoHeaderButtons)otherButtons {
    ...
    if (self) {
        [PAPPhotoHeaderViewFboard validateButtons:otherButtons];
