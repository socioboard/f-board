...
@interface CommentsViewControllerFboard  ()
@property (nonatomic, strong) UITextField *commentTextField;
@property (nonatomic, strong) CommentsHeaderViewControllerFboard *headerView;
@property (nonatomic, assign) BOOL likersQueryInProgress;
@end

static const CGFloat kPAPCellInsetWidth = 20.0f;

@implementation CommentsViewControllerFboard 
...
//    self.navigationItem.titleView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"logo.png"]];
  ...
  //  self.tableView.backgroundView = texturedBackgroundView;
    ...
    self.tableView.backgroundColor=[UIColor colorWithRed:(CGFloat)220/255 green:(CGFloat)220/255 blue:(CGFloat)220/255 alpha:1];
...
//    
    ...
    // Set table footer
    CommentsFooterViewControllerFboard *footerView = [[CommentsFooterViewControllerFboard alloc] initWithFrame:[CommentsFooterViewControllerFboard rectForView]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
   ...
   PAPBaseTextCellFboard *cell = [tableView dequeueReusableCellWithIdentifier:cellID];
    if (cell == nil) {
        cell = [[PAPBaseTextCellFboard alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
...
- (void)cell:(PAPBaseTextCellFboard *)cellView didTapUserButton:(NSString *)aUser {
