...
@interface CustomMenuViewControllerFboard : UIViewController<UITableViewDataSource, UITableViewDelegate, UITabBarDelegate> {
    ...
    CGRect screenSize;
    UIView * rejectView;
    UIImageView * profilePicCurrentUser;
}

@property(nonatomic,strong)AccountViewControllerFboard *account;
...
@property (nonatomic, strong) CustomMenuViewControllerFboard *customMenuViewController;
