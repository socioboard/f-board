...
@implementation PostViewControllerFboard
...
//    self.view.backgroundColor = [UIColor colorWithRed:(CGFloat)23/255 green:(CGFloat)142/255 blue:(CGFloat)210/255 alpha:1];
    ...
    self.postImgButton.frame = CGRectMake(SCREEN_WIDTH/2-150, 90, 100, 130);
    ...
    self.textPostButton.frame = CGRectMake(SCREEN_WIDTH/2+50, 90, 100, 130);
...
-(void)textPostButton:(UIButton *)button{
    PostScheduleControllerFboard *postSchedule=[[PostScheduleControllerFboard alloc] init];
