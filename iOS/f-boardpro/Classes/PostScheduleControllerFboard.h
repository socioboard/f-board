...
@interface PostScheduleControllerFboard : UIViewController<UITextViewDelegate,UIScrollViewDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate>{
    UIToolbar *toolBar;
