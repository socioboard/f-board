...
@interface PAPPhotoHeaderViewFboard : UIView
 ...
 */
- (void)photoHeaderViewFboard:(PAPPhotoHeaderViewFboard *)photoHeaderView didTapUserButton:(UIButton *)button user:(NSString *)user;
 ...
 */
- (void)photoHeaderViewFboard:(PAPPhotoHeaderViewFboard *)photoHeaderView didTapLikePhotoButton:(UIButton *)button photo:(NSString *)photo;
 ...
 */
- (void)photoHeaderViewFboard:(PAPPhotoHeaderViewFboard *)photoHeaderView didTapCommentOnPhotoButton:(UIButton *)button photo:(NSString *)photo;
